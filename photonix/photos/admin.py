...
class LibraryAdmin(VersionedAdmin):
    list_display = ('name', 'classification_color_enabled', 'classification_location_enabled', 'classification_style_enabled', 'classification_object_enabled', 'classification_face_enabled', 'classification_event_enabled', 'classification_clip_enabled', 'setup_stage_completed', 'created_at', 'updated_at')
    ordering = ('name',)
    list_filter = ('classification_color_enabled', 'classification_location_enabled', 'classification_style_enabled', 'classification_object_enabled', 'classification_face_enabled', 'classification_event_enabled', 'classification_clip_enabled', 'setup_stage_completed',)
    inlines = [LibraryUserInline, LibraryPathInline]

    fieldsets = (
        (None, {
            'fields': ('name', 'classification_color_enabled', 'classification_location_enabled', 'classification_style_enabled', 'classification_object_enabled', 'classification_face_enabled', 'classification_event_enabled', 'classification_clip_enabled','setup_stage_completed'),
        }),
