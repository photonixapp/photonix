# Generated by Django 3.0.2 on 2020-01-24 10:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_path', models.CharField(blank=True, help_text='Path for storing photos - local path or bucket name', max_length=128, null=True)),
                ('base_url', models.CharField(blank=True, help_text='If a public-facing URL is available to access block storage, client will use this to download photos', max_length=128, null=True)),
                ('base_thumbnail_path', models.CharField(blank=True, help_text='Path for storing auto-generated photo thumbnails - local path or bucket name', max_length=128, null=True)),
                ('base_thumbnail_url', models.CharField(blank=True, help_text='If a public-facing URL is available to access block storage, client will use this to download thumbnails', max_length=128, null=True)),
                ('import_path', models.CharField(blank=True, help_text='Local path where photos should be imported from', max_length=128, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('library', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='photos', to='photos.Library')),
            ],
            options={
                'ordering': ['-taken_at'],
            },
