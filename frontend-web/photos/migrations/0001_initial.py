# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-14 23:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(blank=True)),
                ('name', models.CharField(max_length=128)),
                ('type', models.CharField(choices=[('L', 'Location'), ('F', 'Feature'), ('P', 'Person')], max_length=1, null=True)),
                ('source', models.CharField(choices=[('H', 'Human'), ('C', 'Computer')], max_length=1)),
                ('city', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='world.City')),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='photos.Tag')),
                ('world_border', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='world.WorldBorder')),
            ],
            options={
                'abstract': False,
            },
